...
## 0.3 — Windows GUI (다음 단계)

- [ ] PowerShell 명령을 몰라도 사용할 수 있는 한국어 단계별 화면
- [ ] PC 확인·설치·재개·설정·검증 진행 표시
- [ ] 설치 계획과 기본값 `N`인 변경 승인 화면
- [ ] 중단된 설치 감지와 한 번 누르는 이어하기
- [ ] 오류 코드·로그 위치·문제 해결 파일 생성 안내
- [ ] 키보드 탐색, 화면 읽기 도구, 고대비 등 접근성 확인
